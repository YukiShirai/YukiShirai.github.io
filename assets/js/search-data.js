    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          title: 'I joined MERL as a Postdoctoral Research Fellow!',
          description: "",
          section: "News",},{id: "news-our-paper-robust-pivoting-manipulation-using-contact-implicit-bilevel-optimization-has-been-accepted-for-the-ieee-transactions-on-robotics-tro",
          title: 'Our paper, “Robust Pivoting Manipulation Using Contact Implicit Bilevel Optimization”, has been accepted...',
          description: "",
          ...
          title: 'My work during my internship at BDAI and my work at MERL were...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%79%75%6B%69%73%68%69%72%61%69%31%39%32%36@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/yuki-shirai-robot", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=eQToH28AAAAJ", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/Yuki_Doradora", "_blank");
        },
      },{
        id: 'social-youtube',
        title: 'YouTube',
        section: 'Socials',
        handler: () => {
          window.open("https://youtube.com/@yukishirai296", "_blank");
        },
      },{
      id: 'light-theme',
